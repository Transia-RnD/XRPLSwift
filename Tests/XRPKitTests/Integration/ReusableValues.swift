...
final class ReusableValues: XCTestCase {
    ...
    public static var destWallet: XRPSeedWallet = try! XRPSeedWallet(seed: "sEdVWZmeUDgQdMEFKTK9kYVX71FKB7o")
    public static var destination: XRPAddress = try! XRPAddress(rAddress: destWallet.address)
    ...
    public static var amount = try! XRPAmount(drops: 1000000) // 1.0 XRP
}
