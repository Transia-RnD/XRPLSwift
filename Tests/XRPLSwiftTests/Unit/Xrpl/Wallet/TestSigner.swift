...
final class TestSigner: XCTestCase {
    ...
    var multisignTxToCombine1: rTransaction!
    var multisignTxToCombine2: rTransaction!
    ...
    override func setUp() {
        ...
        self.multisignTxToCombine1 = try! rTransaction([
        ...
        self.multisignTxToCombine2 = try! rTransaction([
            "Account": "rEuLyBCvcw4CFmzv8RepSiAoNgF8tTGJQC",
            "Fee": "30000",
            "Flags": 262144,
            "LimitAmount": [
...
//    }
    ...
    func testInvalidMultisignTxsDiff() {
        let differentMultisignedTx: rTransaction = try! rTransaction([
            "TransactionType": "Payment",
            "Sequence": 1,
            "Amount": "20000000",
            "Fee": "12",
...
//        XCTAssertThrowsError(try rSigner.multisign(transactions: transactions))
    ...
    func testValidChannelSECP() {
        ...
        XCTAssertEqual(rSigner.authorizeChannel(wallet: secpWallet, channelId: channelId, amount: amount), "304402204E7052F33DDAFAAA55C9F5B132A5E50EE95B2CF68C0902F61DFE77299BC893740220353640B951DCD24371C16868B3F91B78D38B6F3FD1E826413CDF891FA8250AAC")
    }
    ...
    func testValidChannelED() {
        ...
        let channelId: String = "5DB01B7FFED6B67E6B0414DED11E051D2EE2B7619CE0EAA6286D67A3A4D5BDB3"
        let amount: String = "1000000"
        XCTAssertEqual(rSigner.authorizeChannel(wallet: secpWallet, channelId: channelId, amount: amount), "7E1C217A3E4B3C107B7A356E665088B4FBA6464C48C58267BEF64975E3375EA338AE22E6714E3F5E734AE33E6B97AAD59058E1E196C1F92346FC1498D0674404")
    }
    
    func testValidSignatureBlob() {
        let signedTx = try! self.verifyWallet.sign(transaction: self.tx)
        XCTAssertTrue(rSigner.verifySignature(tx: signedTx.txBlob))
    }
//
