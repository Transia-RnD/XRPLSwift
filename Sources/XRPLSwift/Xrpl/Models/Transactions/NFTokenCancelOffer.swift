...
public class NFTokenCancelOffer: BaseTransaction {
    ...
    public override init(json: [String: AnyObject]) throws {
        ...
        let r = try decoder.decode(NFTokenCancelOffer.self, from: data)
        self.nftokenOffers = r.nftokenOffers
 ...
 */
public func validateNFTokenCancelOffer(tx: [String: AnyObject]) throws -> Void {
